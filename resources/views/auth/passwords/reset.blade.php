            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form method="POST" action="{{ lurl('password/reset') }}" class="mx-4 pb-5">
                            {!! csrf_field() !!}
                            ...
                            <div class="form-group">
                                <input type="text" name="login" value="{{ old('login') }}" placeholder="Email" class="form-control{{ $loginError }}">
                            </div>
                            
                            <!-- password -->
                            <?php $passwordError = (isset($errors) and $errors->has('password')) ? ' is-invalid' : ''; ?>
                            <div class="form-group">
                                <input type="password" name="password" placeholder="password" class="form-control email{{ $passwordError }}">
                            </div>
                            
                            <!-- password_confirmation -->
                            <?php $passwordError = (isset($errors) and $errors->has('password')) ? ' is-invalid' : ''; ?>
                            <div class="form-group">
                                <input type="password" name="password_confirmation" placeholder="confirm password" class="form-control email{{ $passwordError }}">
                            </div>
                            ...
                            <!-- Submit -->
                            <div class="form-group">
                                <button type="submit" class="btn btn-primary btn-lg btn-block">Reset the Password</button>
                            </div>
                        </form>
                    </div>
                </div>
