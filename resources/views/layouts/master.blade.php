...
<head>
	...
	<link href="{{ url('assets/css/lightslider.min.css')}}" rel="stylesheet">
...
<script>
	...
	$(document).ready(function() {
		$("#imageGallery").lightSlider({item:1,verticalHeight:300,loop:true,pager:false,auto:true,speed:500,}); 
		$("#clientlogos").lightSlider({item:5,loop:true,auto:true,speed:400,pager:false,autoWidth:true,}); 
