	...
	*/
	public function setValueAttribute($value)
	{
		...
		if (isset($value['logo_dark'])) {
			...
			$value = $this->upload($value, $logoDark);
		}
		...
		if (isset($value['logo_light'])) {
			...
			$value = $this->upload($value, $logoLight);
		}
		...
		if (isset($value['login_bg_image'])) {
			...
			$value = $this->upload($value, $loginBgImage);
		}
	...
	public function getFieldAttribute($value)
	{
		...
		$breadcrumb = trans('admin.Admin panel') . ' &rarr; '
			...
			. mb_ucwords(trans('admin.general settings')) . ' &rarr; ';
	...
	{"name":"auto_detect_language","label":"auto_detect_language_label","type":"select2_from_array","options":{"0":"' . trans('admin.auto_detect_language_option_0') . '","1":"' . trans('admin.auto_detect_language_option_1') . '","2":"' . trans('admin.auto_detect_language_option_2') . '"},"wrapperAttributes":{"class":"form-group col-md-6"}},
	{"name":"auto_detect_language_warning_sep","type":"custom_html","value":"auto_detect_language_warning_sep_value"},
	
	{"name":"separator_2","type":"custom_html","value":"app_html_date_format"},
	{"name":"default_date_format","label":"Date Format","type":"text","hint":"app_html_date_format_hint","wrapperAttributes":{"class":"form-group col-md-6"}},
	{"name":"default_datetime_format","label":"Date Time Format","type":"text","hint":"app_html_date_format_hint","wrapperAttributes":{"class":"form-group col-md-6"}},
	{"name":"default_timezone","label":"Default Timezone","type":"select2","attribute":"time_zone_id","key":"time_zone_id","model":"\\\App\\\Models\\\TimeZone","hint":"This option is used in the Admin panel","wrapperAttributes":{"class":"form-group col-md-6"}},
	...
	{"name":"backend_title_separator","type":"custom_html","value":"backend_title_separator"},
	
	{"name":"logo_dark","label":"logo_dark_label","type":"image","upload":"true","disk":"' . $diskName . '","default":"' . config('larapen.admin.logo.dark') . '","hint":"logo_dark_hint","wrapperAttributes":{"class":"form-group col-md-6"}},
	{"name":"logo_light","label":"logo_light_label","type":"image","upload":"true","disk":"' . $diskName . '","default":"' . config('larapen.admin.logo.light') . '","hint":"logo_light_hint","wrapperAttributes":{"class":"form-group col-md-6"}},
	
	{"name":"settings_app_dashboard_sep","type":"custom_html","value":"settings_app_dashboard_sep"},
	{"name":"vector_charts_type","label":"vector_charts_type_label","type":"select2_from_array","options":{"morris_bar":"Morris - Bar Charts","morris_line":"Morris - Line Charts"},"wrapperAttributes":{"class":"form-group col-md-6"}},
	...
	{"name":"show_countries_charts","label":"show_countries_charts_label","type":"checkbox","wrapperAttributes":{"class":"form-group col-md-6","style":"margin-top: 20px;"}}';
		...
		if ($this->key == 'style') {
			$value = '{"name":"separator_1","type":"custom_html","value":"style_html_frontend"},
	...
	{"name":"separator_2","type":"custom_html","value":"style_html_customize_front"},
	{"name":"separator_2_1","type":"custom_html","value":"style_html_customize_front_global"},
	...
	{"name":"page_width","label":"Page Width","type":"number","wrapperAttributes":{"class":"form-group col-md-6"}},
	...
	{"name":"separator_2_2","type":"custom_html","value":"style_html_customize_header"},
	{"name":"header_sticky","label":"Header Sticky","type":"checkbox"},
	{"name":"header_height","label":"Header Height","type":"number","wrapperAttributes":{"class":"form-group col-md-6"}},
	...
	{"name":"header_bottom_border_width","label":"Header Bottom Border Width","type":"number","wrapperAttributes":{"class":"form-group col-md-6"}},
	...
	{"name":"separator_2_3","type":"custom_html","value":"style_html_customize_footer"},
	...
	{"name":"payment_icon_top_border_width","label":"Payment Methods Icons Top Border Width","type":"number","wrapperAttributes":{"class":"form-group col-md-6"}},
	...
	{"name":"payment_icon_bottom_border_width","label":"Payment Methods Icons Bottom Border Width","type":"number","wrapperAttributes":{"class":"form-group col-md-6"}},
	...
	{"name":"separator_2_4","type":"custom_html","value":"style_html_customize_button_al"},
	...
	{"name":"separator_3","type":"custom_html","value":"style_html_raw_css"},
	{"name":"separator_3_1","type":"custom_html","value":"style_html_raw_css_hint"},
	{"name":"custom_css","label":"Custom CSS","type":"textarea","attributes":{"rows":"5"},"hint":"do_not_include_style_tags"},
	
	{"name":"backend_title_separator","type":"custom_html","value":"backend_title_separator"},
	
	{"name":"login_bg_image","label":"login_bg_image_label","type":"image","upload":"true","disk":"' . $diskName . '","default":"' . config('larapen.admin.login_bg_image') . '","hint":"login_bg_image_hint","wrapperAttributes":{"class":"form-group col-md-6"}},
	{"name":"separator_clear_3","type":"custom_html","value":"<div style=\"clear: both;\"></div>"},
	{"name":"admin_logo_bg","label":"admin_logo_bg_label","type":"select2_from_array","options":{"skin1":"Green","skin2":"Red","skin3":"Blue","skin4":"Purple","skin5":"Black","skin6":"White"},"wrapperAttributes":{"class":"form-group col-md-6"}},
	{"name":"admin_navbar_bg","label":"admin_navbar_bg_label","type":"select2_from_array","options":{"skin1":"Green","skin2":"Red","skin3":"Blue","skin4":"Purple","skin5":"Black","skin6":"White"},"wrapperAttributes":{"class":"form-group col-md-6"}},
	{"name":"admin_sidebar_type","label":"admin_sidebar_type_label","type":"select2_from_array","options":{"full":"Full","mini-sidebar":"Mini Sidebar","iconbar":"Icon Bbar","overlay":"Overlay"},"hint":"admin_sidebar_type_hint","wrapperAttributes":{"class":"form-group col-md-6"}},
	{"name":"admin_sidebar_bg","label":"admin_sidebar_bg_label","type":"select2_from_array","options":{"skin1":"Green","skin2":"Red","skin3":"Blue","skin4":"Purple","skin5":"Black","skin6":"White"},"wrapperAttributes":{"class":"form-group col-md-6"}},
	{"name":"separator_clear_4","type":"custom_html","value":"<div style=\"clear: both;\"></div>"},
	{"name":"admin_sidebar_position","label":"admin_sidebar_position_label","type":"checkbox","hint":"admin_sidebar_position_hint","wrapperAttributes":{"class":"form-group col-md-6","style":"margin-top: 20px;"}},
	{"name":"admin_header_position","label":"admin_header_position_label","type":"checkbox","hint":"admin_header_position_hint","wrapperAttributes":{"class":"form-group col-md-6","style":"margin-top: 20px;"}},
	{"name":"admin_boxed_layout","label":"admin_boxed_layout_label","type":"checkbox","hint":"admin_boxed_layout_hint","wrapperAttributes":{"class":"form-group col-md-6","style":"margin-top: 20px;"}},
	{"name":"admin_dark_theme","label":"admin_dark_theme_label","type":"checkbox","hint":"admin_dark_theme_hint","wrapperAttributes":{"class":"form-group col-md-6","style":"margin-top: 20px;"}}';
		}
		
		if ($this->key == 'listing') {
			$value = '{"name":"separator_1","type":"custom_html","value":"listing_html_displaying"},
	...
	{"name":"items_per_page","label":"Items per page","type":"number","hint":"Number of items per page","wrapperAttributes":{"class":"form-group col-md-6"}},
	...
	{"name":"separator_2","type":"custom_html","value":"listing_html_distance"},
	{"name":"cities_extended_searches","label":"Enable the cities extended searches","type":"checkbox","hint":"cities_extended_searches_hint","wrapperAttributes":{"class":"form-group col-md-12"}}';
			if (DBTool::isMySqlMinVersion('5.7.6')) {
				$value .= ',{"name":"distance_calculation_formula","label":"distance_calculation_formula_label","type":"select2_from_array","options":{"haversine":"' . trans('admin.haversine_formula') . '","orthodromy":"' . trans('admin.orthodromy_formula') . '","ST_Distance_Sphere":"' . trans('admin.mysql_spherical_calculation') . '"},"hint":"distance_calculation_formula_hint","wrapperAttributes":{"class":"form-group col-md-6"}}';
			} else {
				$value .= ',{"name":"distance_calculation_formula","label":"distance_calculation_formula_label","type":"select2_from_array","options":{"haversine":"' . trans('admin.haversine_formula') . '","orthodromy":"' . trans('admin.orthodromy_formula') . '"},"hint":"distance_calculation_formula_hint_lite","wrapperAttributes":{"class":"form-group col-md-6"}}';
			}
			$value .= ',{"name":"search_distance_default","label":"Default Search Distance","type":"select2_from_array","options":{"200":"200","100":"100","50":"50","25":"25","20":"20","10":"10","0":"0"},"hint":"Default search radius distance","wrapperAttributes":{"class":"form-group col-md-6"}},
	{"name":"separator_3","type":"custom_html","value":"<div style=\"clear: both;\"></div>"},
	{"name":"search_distance_max","label":"Max Search Distance","type":"select2_from_array","options":{"1000":"1000","900":"900","800":"800","700":"700","600":"600","500":"500","400":"400","300":"300","200":"200","100":"100","50":"50","0":"0"},"hint":"Max search radius distance","wrapperAttributes":{"class":"form-group col-md-6"}},
	{"name":"search_distance_interval","label":"Distance Interval","type":"select2_from_array","options":{"250":"250","200":"200","100":"100","50":"50","25":"25","20":"20","10":"10","5":"5"},"hint":"The interval between filter distances","wrapperAttributes":{"class":"form-group col-md-6"}}';
		}
		
		if ($this->key == 'single') {
			$value = '{"name":"publication_sep","type":"custom_html","value":"single_html_publication"},
	{"name":"publication_form_type","label":"publication_form_type_label","type":"select2_from_array","options":{"1":"' . trans('admin.publication_form_type_option_1') . '","2":"' . trans('admin.publication_form_type_option_2') . '"},"hint":"publication_form_type_hint","wrapperAttributes":{"class":"form-group col-md-6"}},
	...
	{"name":"separator_clear_1","type":"custom_html","value":"<div style=\"clear: both;\"></div>"},
	{"name":"pictures_limit","label":"Pictures Limit","type":"number","hint":"pictures_limit_hint","wrapperAttributes":{"class":"form-group col-md-6"}},
	{"name":"tags_limit","label":"Tags Limit","type":"number","hint":"single_tags_limit_hint","wrapperAttributes":{"class":"form-group col-md-6"}},
	{"name":"separator_clear_2","type":"custom_html","value":"<div style=\"clear: both;\"></div>"},
	...
	{"name":"permanent_posts_enabled","label":"permanent_posts_label","type":"select2_from_array","options":{"0":"' . trans('admin.permanent_posts_option_0') . '","4":"' . trans('admin.permanent_posts_option_4') . '"},"hint":"permanent_posts_hint","wrapperAttributes":{"class":"form-group col-md-6"}},
	{"name":"pricing_page_enabled","label":"pricing_page_label","type":"select2_from_array","options":{"0":"' . trans('admin.pricing_page_option_0') . '","1":"' . trans('admin.pricing_page_option_1') . '","2":"' . trans('admin.pricing_page_option_2') . '"},"hint":"pricing_page_hint","wrapperAttributes":{"class":"form-group col-md-6"}},
	
	{"name":"auto_registration_sep","type":"custom_html","value":"auto_registration_sep_value"},
	{"name":"auto_registration","label":"auto_registration_label","type":"select2_from_array","options":{"0":"' . trans('admin.auto_registration_option_0') . '","1":"' . trans('admin.auto_registration_option_1') . '","2":"' . trans('admin.auto_registration_option_2') . '"},"hint":"auto_registration_hint","wrapperAttributes":{"class":"form-group col-md-6"}},
	...
	{"name":"wysiwyg_editor","label":"wysiwyg_editor_label","type":"select2_from_array","options":{"none":"' . trans('admin.wysiwyg_editor_none') . '","tinymce":"' . trans('admin.wysiwyg_editor_tinymce') . '","ckeditor":"' . trans('admin.wysiwyg_editor_ckeditor') . '","summernote":"' . trans('admin.wysiwyg_editor_summernote') . '","simditor":"' . trans('admin.wysiwyg_editor_simditor') . '"},"hint":"wysiwyg_editor_hint","wrapperAttributes":{"class":"form-group col-md-6"}},
	...
	{"name":"hide_phone_number","label":"hide_phone_number_label","type":"select2_from_array","options":{"0":"' . trans('admin.hide_phone_number_option_0') . '","1":"' .
				trans('admin.hide_phone_number_option_1') . '","2":"' . trans('admin.hide_phone_number_option_2') . '","3":"' . trans('admin.hide_phone_number_option_3') . '"},"hint":"hide_phone_number_hint","wrapperAttributes":{"class":"form-group col-md-6"}},
	
	{"name":"around_phone_number_sep","type":"custom_html","value":"around_phone_number_sep"},
	{"name":"show_security_tips","label":"show_security_tips_label","type":"checkbox","hint":"show_security_tips_hint","wrapperAttributes":{"class":"form-group col-md-6","style":"margin-top: 10px;"}},
	{"name":"around_phone_number_sep_clear_1","type":"custom_html","value":"<div style=\"clear: both;\"></div>"},
	{"name":"enable_whatsapp_btn","label":"enable_whatsapp_btn_label","type":"checkbox","hint":"enable_whatsapp_btn_hint","wrapperAttributes":{"class":"form-group col-md-6","style":"margin-top: 10px;"}},
	{"name":"pre_filled_whatsapp_message","label":"pre_filled_whatsapp_message_label","type":"checkbox","hint":"pre_filled_whatsapp_message_hint","wrapperAttributes":{"class":"form-group col-md-6","style":"margin-top: 10px;"}},
	...
	{"name":"similar_posts","label":"similar_posts_label","type":"select2_from_array","options":{"0":"' . trans('admin.similar_posts_option_0') . '","1":"' .
				trans('admin.similar_posts_option_1') . '","2":"' . trans('admin.similar_posts_option_2') . '"},"hint":"similar_posts_hint","wrapperAttributes":{"class":"form-group col-md-6"}},
	
	{"name":"external_services_sep","type":"custom_html","value":"single_html_external_services"},
	{"name":"show_post_on_googlemap","label":"Show Ads on Google Maps","type":"checkbox","hint":"show_ads_on_google_maps_hint","wrapperAttributes":{"class":"form-group col-md-6"}},
	{"name":"activation_facebook_comments","label":"Allow Facebook Comments","type":"checkbox","hint":"allow_facebook_comments_hint","wrapperAttributes":{"class":"form-group col-md-6"}}';
		}
	...
	{"name":"port","label":"mail_smtp_port_label","type":"number","hint":"mail_smtp_port_hint","wrapperAttributes":{"class":"form-group col-md-6"}},
	...
	{"name":"separator_1","type":"custom_html","value":"sms_html_nexmo"},
	{"name":"separator_1_1","type":"custom_html","value":"sms_html_nexmo_hint"},
	...
	{"name":"separator_2","type":"custom_html","value":"sms_html_twilio"},
	{"name":"separator_2_1","type":"custom_html","value":"sms_html_twilio_hint"},
	...
	{"name":"separator_4","type":"custom_html","value":"sms_other_sep_value"},
	{"name":"phone_verification","label":"Enable Phone Verification","type":"checkbox","hint":"disable_phone_in_env_hint"},
	{"name":"message_activation","label":"Enable SMS Message","type":"checkbox","hint":"enable_sms_message_hint"}';
		}
	...
	{"name":"min_file_size","label":"min_file_size_label","type":"number","hint":"min_file_size_hint","wrapperAttributes":{"class":"form-group col-md-3"}},
	{"name":"max_file_size","label":"max_file_size_label","type":"number","hint":"max_file_size_hint","wrapperAttributes":{"class":"form-group col-md-3"}},
	...
	{"name":"min_image_size","label":"min_image_size_label","type":"number","hint":"min_image_size_hint","wrapperAttributes":{"class":"form-group col-md-6"}},
	{"name":"max_image_size","label":"max_image_size_label","type":"number","hint":"max_image_size_hint","wrapperAttributes":{"class":"form-group col-md-6"}},
	...
	{"name":"img_resize_width","label":"img_resize_width_label","type":"number","hint":"img_resize_width_hint","wrapperAttributes":{"class":"form-group col-md-6"}},
	{"name":"img_resize_height","label":"img_resize_height_label","type":"number","hint":"img_resize_height_hint","wrapperAttributes":{"class":"form-group col-md-6"}},
	...
	{"name":"img_resize_logo_width","label":"img_resize_width_label","type":"number","hint":"img_resize_width_hint","wrapperAttributes":{"class":"form-group col-md-6"}},
	{"name":"img_resize_logo_height","label":"img_resize_height_label","type":"number","hint":"img_resize_height_hint","wrapperAttributes":{"class":"form-group col-md-6"}},
	...
	{"name":"img_resize_cat_sep","type":"custom_html","value":"img_resize_cat_sep_value"},
	{"name":"img_resize_cat_width","label":"img_resize_width_label","type":"number","hint":"img_resize_width_hint","wrapperAttributes":{"class":"form-group col-md-6"}},
	{"name":"img_resize_cat_height","label":"img_resize_height_label","type":"number","hint":"img_resize_height_hint","wrapperAttributes":{"class":"form-group col-md-6"}},
	{"name":"img_resize_cat_ratio","label":"img_resize_ratio_label","type":"checkbox","hint":"img_resize_ratio_hint","wrapperAttributes":{"class":"form-group col-md-6"}},
	{"name":"img_resize_cat_upsize","label":"img_resize_upsize_label","type":"checkbox","hint":"img_resize_upsize_hint","wrapperAttributes":{"class":"form-group col-md-6"}},
	...
	{"name":"img_resize_small_resize_type","label":"img_resize_type_resize_type_label","type":"select2_from_array","options":{"0":"' . trans('admin.img_resize_type_resize_type_option_0') . '","1":"' . trans('admin.img_resize_type_resize_type_option_1') . '","2":"' . trans('admin.img_resize_type_resize_type_option_2') . '"},"hint":"img_resize_type_resize_type_hint","wrapperAttributes":{"class":"form-group col-md-6"}},
	{"name":"sep_3_2","type":"custom_html","value":"<div style=\"clear: both;\"></div>"},
	{"name":"img_resize_small_width","label":"img_resize_type_width_label","type":"number","hint":"img_resize_type_width_hint","wrapperAttributes":{"class":"form-group col-md-6"}},
	{"name":"img_resize_small_height","label":"img_resize_type_height_label","type":"number","hint":"img_resize_type_height_hint","wrapperAttributes":{"class":"form-group col-md-6"}},
	...
	{"name":"img_resize_small_position","label":"img_resize_type_position_label","type":"select2_from_array","options":{"top-left":"' . trans('admin.img_resize_type_position_option_0') . '","top":"' . trans('admin.img_resize_type_position_option_1') . '","top-right":"' . trans('admin.img_resize_type_position_option_2') . '","left":"' . trans('admin.img_resize_type_position_option_3') . '","center":"' . trans('admin.img_resize_type_position_option_4') . '","right":"' . trans('admin.img_resize_type_position_option_5') . '","bottom-left":"' . trans('admin.img_resize_type_position_option_6') . '","bottom":"' . trans('admin.img_resize_type_position_option_7') . '","bottom-right":"' . trans('admin.img_resize_type_position_option_8') . '"},"hint":"img_resize_type_position_hint","wrapperAttributes":{"class":"form-group col-md-4"}},
	...
	{"name":"img_resize_medium_width","label":"img_resize_type_width_label","type":"number","hint":"img_resize_type_width_hint","wrapperAttributes":{"class":"form-group col-md-6"}},
	{"name":"img_resize_medium_height","label":"img_resize_type_height_label","type":"number","hint":"img_resize_type_height_hint","wrapperAttributes":{"class":"form-group col-md-6"}},
	...
	{"name":"img_resize_medium_position","label":"img_resize_type_position_label","type":"select2_from_array","options":{"top-left":"' . trans('admin.img_resize_type_position_option_0') . '","top":"' . trans('admin.img_resize_type_position_option_1') . '","top-right":"' . trans('admin.img_resize_type_position_option_2') . '","left":"' . trans('admin.img_resize_type_position_option_3') . '","center":"' . trans('admin.img_resize_type_position_option_4') . '","right":"' . trans('admin.img_resize_type_position_option_5') . '","bottom-left":"' . trans('admin.img_resize_type_position_option_6') . '","bottom":"' . trans('admin.img_resize_type_position_option_7') . '","bottom-right":"' . trans('admin.img_resize_type_position_option_8') . '"},"hint":"img_resize_type_position_hint","wrapperAttributes":{"class":"form-group col-md-4"}},
	...
	{"name":"img_resize_big_width","label":"img_resize_type_width_label","type":"number","hint":"img_resize_type_width_hint","wrapperAttributes":{"class":"form-group col-md-6"}},
	{"name":"img_resize_big_height","label":"img_resize_type_height_label","type":"number","hint":"img_resize_type_height_hint","wrapperAttributes":{"class":"form-group col-md-6"}},
	...
	{"name":"img_resize_big_position","label":"img_resize_type_position_label","type":"select2_from_array","options":{"top-left":"' . trans('admin.img_resize_type_position_option_0') . '","top":"' . trans('admin.img_resize_type_position_option_1') . '","top-right":"' . trans('admin.img_resize_type_position_option_2') . '","left":"' . trans('admin.img_resize_type_position_option_3') . '","center":"' . trans('admin.img_resize_type_position_option_4') . '","right":"' . trans('admin.img_resize_type_position_option_5') . '","bottom-left":"' . trans('admin.img_resize_type_position_option_6') . '","bottom":"' . trans('admin.img_resize_type_position_option_7') . '","bottom-right":"' . trans('admin.img_resize_type_position_option_8') . '"},"hint":"img_resize_type_position_hint","wrapperAttributes":{"class":"form-group col-md-4"}},
	...
	{"name":"img_resize_big_bg_color","label":"img_resize_type_bg_color_label","type":"color_picker","colorpicker_options":{"customClass":"custom-class"},"attributes":{"placeholder":"#FFFFFF"},"hint":"img_resize_type_bg_color_hint","wrapperAttributes":{"class":"form-group col-md-4"}}';
			...
			if (auth()->user()->can('clear-images-thumbnails') || userHasSuperAdminPermissions()) {
				...
				$value .= ',{"name":"clear_images_thumbnails_sep","type":"custom_html","value":"clear_images_thumbnails_sep_value"},
		...
		if ($this->key == 'geo_location') {
			$value = '{"name":"geolocation_activation","label":"Enable Geolocation","type":"checkbox","hint":"enable_geolocation_hint","wrapperAttributes":{"class":"form-group col-md-6","style":"margin-top: 20px;"}},
	...
	{"name":"cache_expiration","label":"cache_expiration_label","type":"number","hint":"cache_expiration_hint","wrapperAttributes":{"class":"form-group col-md-6"}},
	...
	{"name":"memcached_servers_1_host","label":"' . trans('admin.memcached_servers_host_label', ['num' => 1]) . '","type":"text","hint":"' . trans('admin.memcached_servers_host_hint') . '","wrapperAttributes":{"class":"form-group col-md-6"},"disableTrans":"true"},
	{"name":"memcached_servers_1_port","label":"' . trans('admin.memcached_servers_port_label', ['num' => 1]) . '","type":"number","hint":"' . trans('admin.memcached_servers_port_hint') . '","wrapperAttributes":{"class":"form-group col-md-6"},"disableTrans":"true"},
	{"name":"memcached_servers_2_host","label":"' . trans('admin.memcached_servers_host_label', ['num' => 2]) . ' (' . trans('admin.Optional') . ')","type":"text","wrapperAttributes":{"class":"form-group col-md-6"},"disableTrans":"true"},
	{"name":"memcached_servers_2_port","label":"' . trans('admin.memcached_servers_port_label', ['num' => 2]) . ' (' . trans('admin.Optional') . ')","type":"number","wrapperAttributes":{"class":"form-group col-md-6"},"disableTrans":"true"},
	{"name":"memcached_servers_3_host","label":"' . trans('admin.memcached_servers_host_label', ['num' => 3]) . ' (' . trans('admin.Optional') . ')","type":"text","wrapperAttributes":{"class":"form-group col-md-6"},"disableTrans":"true"},
	{"name":"memcached_servers_3_port","label":"' . trans('admin.memcached_servers_port_label', ['num' => 3]) . ' (' . trans('admin.Optional') . ')","type":"number","wrapperAttributes":{"class":"form-group col-md-6"},"disableTrans":"true"},
	...
	{"name":"redis_port","label":"redis_port_label","type":"number","hint":"redis_port_hint","wrapperAttributes":{"class":"form-group col-md-6"}},
	...
	{"name":"redis_cluster_1_host","label":"' . trans('admin.redis_cluster_host_label', ['num' => 1]) . '","type":"text","hint":"' . trans('admin.redis_cluster_host_hint') . '","wrapperAttributes":{"class":"form-group col-md-6"},"disableTrans":"true"},
	{"name":"redis_cluster_1_password","label":"' . trans('admin.redis_cluster_password_label', ['num' => 1]) . '","type":"text","hint":"' . trans('admin.redis_cluster_password_hint') . '","wrapperAttributes":{"class":"form-group col-md-6"},"disableTrans":"true"},
	{"name":"redis_cluster_1_port","label":"' . trans('admin.redis_cluster_port_label', ['num' => 1]) . '","type":"number","hint":"' . trans('admin.redis_cluster_port_hint') . '","wrapperAttributes":{"class":"form-group col-md-6"},"disableTrans":"true"},
	{"name":"redis_cluster_1_database","label":"' . trans('admin.redis_cluster_database_label', ['num' => 1]) . '","type":"text","hint":"' . trans('admin.redis_cluster_database_hint') . '","wrapperAttributes":{"class":"form-group col-md-6"},"disableTrans":"true"},
	{"name":"redis_cluster_2_host","label":"' . trans('admin.redis_cluster_host_label', ['num' => 2]) . ' (' . trans('admin.Optional') . ')","type":"text","wrapperAttributes":{"class":"form-group col-md-6"},"disableTrans":"true"},
	{"name":"redis_cluster_2_password","label":"' . trans('admin.redis_cluster_password_label', ['num' => 2]) . ' (' . trans('admin.Optional') . ')","type":"text","wrapperAttributes":{"class":"form-group col-md-6"},"disableTrans":"true"},
	{"name":"redis_cluster_2_port","label":"' . trans('admin.redis_cluster_port_label', ['num' => 2]) . ' (' . trans('admin.Optional') . ')","type":"number","wrapperAttributes":{"class":"form-group col-md-6"},"disableTrans":"true"},
	{"name":"redis_cluster_2_database","label":"' . trans('admin.redis_cluster_database_label', ['num' => 2]) . ' (' . trans('admin.Optional') . ')","type":"text","wrapperAttributes":{"class":"form-group col-md-6"},"disableTrans":"true"},
	{"name":"redis_cluster_3_host","label":"' . trans('admin.redis_cluster_host_label', ['num' => 3]) . ' (' . trans('admin.Optional') . ')","type":"text","wrapperAttributes":{"class":"form-group col-md-6"},"disableTrans":"true"},
	{"name":"redis_cluster_3_password","label":"' . trans('admin.redis_cluster_password_label', ['num' => 3]) . ' (' . trans('admin.Optional') . ')","type":"text","wrapperAttributes":{"class":"form-group col-md-6"},"disableTrans":"true"},
	{"name":"redis_cluster_3_port","label":"' . trans('admin.redis_cluster_port_label', ['num' => 3]) . ' (' . trans('admin.Optional') . ')","type":"number","wrapperAttributes":{"class":"form-group col-md-6"},"disableTrans":"true"},
	{"name":"redis_cluster_3_database","label":"' . trans('admin.redis_cluster_database_label', ['num' => 3]) . ' (' . trans('admin.Optional') . ')","type":"text","wrapperAttributes":{"class":"form-group col-md-6"},"disableTrans":"true"},
	...
	{"name":"robots_txt_info","type":"custom_html","value":"' . addslashes(trans('admin.robots_txt_info_value', ['domain' => url('/')])) . '","disableTrans":"true"},
	{"name":"robots_txt","label":"robots_txt_label","type":"textarea","attributes":{"rows":"5"},"hint":"robots_txt_hint"},
	{"name":"robots_txt_sm_indexes","label":"' . addslashes(trans('admin.robots_txt_sm_indexes_label')) . '","type":"checkbox","hint":"' . addslashes(trans('admin.robots_txt_sm_indexes_hint', ['indexes' => getSitemapsIndexes(true)])) . '","wrapperAttributes":{"class":"form-group col-md-12"},"disableTrans":"true"},
	
	{"name":"separator_2","type":"custom_html","value":"seo_html_indexing"},
	...
	{"name":"separator_3","type":"custom_html","value":"seo_html_permalink"},
	...
	{"name":"separator_4","type":"custom_html","value":"seo_html_multi_countries_urls"},
	...
	{"name":"separator_4_2","type":"custom_html","value":"multi_countries_urls_optimization_info"}';
		...
		if ($this->key == 'other') {
			$value = '{"name":"separator_1","type":"custom_html","value":"other_html_alerts_boxes"},
	...
	{"name":"show_tips_messages","label":"Show Tips Notification Messages","type":"checkbox","hint":"show_tips_messages_hint","wrapperAttributes":{"class":"form-group col-md-6"}},
	
	{"name":"separator_2","type":"custom_html","value":"other_html_google_maps"},
	{"name":"googlemaps_key","label":"Google Maps Key","type":"text","wrapperAttributes":{"class":"form-group col-md-6"}},
	
	{"name":"separator_3","type":"custom_html","value":"other_html_conversation"},
	{"name":"timer_new_messages_checking","label":"Timer for New Messages Checking","type":"number","hint":"timer_new_messages_checking_hint","wrapperAttributes":{"class":"form-group col-md-6"}},
	
	{"name":"separator_4","type":"custom_html","value":"textarea_editor_h3"},
	{"name":"wysiwyg_editor","label":"wysiwyg_editor_label","type":"select2_from_array","options":{"none":"' . trans('admin.wysiwyg_editor_none') . '","tinymce":"' . trans('admin.wysiwyg_editor_tinymce') . '","ckeditor":"' . trans('admin.wysiwyg_editor_ckeditor') . '","summernote":"' . trans('admin.wysiwyg_editor_summernote') . '","simditor":"' . trans('admin.wysiwyg_editor_simditor') . '"},"hint":"wysiwyg_editor_hint","wrapperAttributes":{"class":"form-group col-md-6"}},
	
	{"name":"separator_5","type":"custom_html","value":"other_html_mobile_app"},
	...
	{"name":"separator_6","type":"custom_html","value":"other_html_number_format"},
	...
	{"name":"cookie_expiration","label":"cookie_expiration_label","type":"number","hint":"cookie_expiration_hint","wrapperAttributes":{"class":"form-group col-md-6"}},
	
	{"name":"separator_8","type":"custom_html","value":"other_html_head_js"},
	{"name":"js_code","label":"JavaScript Code","type":"textarea","attributes":{"rows":"10"},"hint":"js_code_hint"}';
		}
	...
	{"name":"unactivated_posts_expiration","label":"unactivated_posts_expiration_label","type":"number", "hint":"unactivated_posts_expiration_hint","wrapperAttributes":{"class":"form-group col-md-6"}},
	{"name":"activated_posts_expiration","label":"activated_posts_expiration_label","type":"number", "hint":"activated_posts_expiration_hint","wrapperAttributes":{"class":"form-group col-md-6"}},
	{"name":"archived_posts_expiration","label":"archived_posts_expiration_label","type":"number", "hint":"archived_posts_expiration_hint","wrapperAttributes":{"class":"form-group col-md-6"}},
	{"name":"manually_archived_posts_expiration","label":"manually_archived_posts_expiration_label","type":"number", "hint":"manually_archived_posts_expiration_hint","wrapperAttributes":{"class":"form-group col-md-6"}}';
		}
	...
	{"name":"tracking_code","label":"Tracking Code","type":"textarea","attributes":{"rows":"15"},"hint":"tracking_code_hint"}';
		...
		if ($this->key == 'backup') {
			$value = '{"name":"storage_disk","label":"storage_disk_label","type":"select2_from_array","options":{"0":"' . trans('admin.storage_disk_option_0') . '","1":"' .
				trans('admin.storage_disk_option_1') . '","2":"' . trans('admin.storage_disk_option_2') . '"},
	...
	{"name":"backup_sep_2","type":"custom_html","value":"<hr>"},
	{"name":"cron_info_sep","type":"custom_html","value":"cron_info_sep_value"},
	...
	{"name":"backup_frequency_all","label":"backup_frequency_label","type":"select2_from_array","options":{"0":"' . trans('admin.backup_frequency_option_0') . '","1":"' .
				trans('admin.backup_frequency_option_1') . '","2":"' .
				trans('admin.backup_frequency_option_2') . '","3":"' . trans('admin.backup_frequency_option_3') . '","4":"' . trans('admin.backup_frequency_option_4') . '","5":"' . trans('admin.backup_frequency_option_5') . '","6":"' . trans('admin.backup_frequency_option_6') . '","7":"' . trans('admin.backup_frequency_option_7') . '","14":"' .
				trans('admin.backup_frequency_option_8') . '","21":"' .
				trans('admin.backup_frequency_option_9') . '","30":"' . trans('admin.backup_frequency_option_10') . '","60":"' . trans('admin.backup_frequency_option_11') . '","90":"' . trans('admin.backup_frequency_option_12') . '","180":"' . trans('admin.backup_frequency_option_13') . '","360":"' . trans('admin.backup_frequency_option_14') . '"},
	...
	{"name":"backup_frequency_database","label":"backup_frequency_label","type":"select2_from_array","options":{"0":"' . trans('admin.backup_frequency_option_0') . '","1":"' .
				trans('admin.backup_frequency_option_1') . '","2":"' .
				trans('admin.backup_frequency_option_2') . '","3":"' . trans('admin.backup_frequency_option_3') . '","4":"' . trans('admin.backup_frequency_option_4') . '","5":"' . trans('admin.backup_frequency_option_5') . '","6":"' . trans('admin.backup_frequency_option_6') . '","7":"' . trans('admin.backup_frequency_option_7') . '","14":"' .
				trans('admin.backup_frequency_option_8') . '","21":"' .
				trans('admin.backup_frequency_option_9') . '","30":"' . trans('admin.backup_frequency_option_10') . '","60":"' . trans('admin.backup_frequency_option_11') . '","90":"' . trans('admin.backup_frequency_option_12') . '","180":"' . trans('admin.backup_frequency_option_13') . '","360":"' . trans('admin.backup_frequency_option_14') . '"},
	...
	{"name":"backup_frequency_files","label":"backup_frequency_label","type":"select2_from_array","options":{"0":"' . trans('admin.backup_frequency_option_0') . '","1":"' .
				trans('admin.backup_frequency_option_1') . '","2":"' .
				trans('admin.backup_frequency_option_2') . '","3":"' . trans('admin.backup_frequency_option_3') . '","4":"' . trans('admin.backup_frequency_option_4') . '","5":"' . trans('admin.backup_frequency_option_5') . '","6":"' . trans('admin.backup_frequency_option_6') . '","7":"' . trans('admin.backup_frequency_option_7') . '","14":"' .
				trans('admin.backup_frequency_option_8') . '","21":"' .
				trans('admin.backup_frequency_option_9') . '","30":"' . trans('admin.backup_frequency_option_10') . '","60":"' . trans('admin.backup_frequency_option_11') . '","90":"' . trans('admin.backup_frequency_option_12') . '","180":"' . trans('admin.backup_frequency_option_13') . '","360":"' . trans('admin.backup_frequency_option_14') . '"},
	...
	{"name":"backup_frequency_languages","label":"backup_frequency_label","type":"select2_from_array","options":{"0":"' . trans('admin.backup_frequency_option_0') . '","1":"' .
				trans('admin.backup_frequency_option_1') . '","2":"' .
				trans('admin.backup_frequency_option_2') . '","3":"' . trans('admin.backup_frequency_option_3') . '","4":"' . trans('admin.backup_frequency_option_4') . '","5":"' . trans('admin.backup_frequency_option_5') . '","6":"' . trans('admin.backup_frequency_option_6') . '","7":"' . trans('admin.backup_frequency_option_7') . '","14":"' .
				trans('admin.backup_frequency_option_8') . '","21":"' .
				trans('admin.backup_frequency_option_9') . '","30":"' . trans('admin.backup_frequency_option_10') . '","60":"' . trans('admin.backup_frequency_option_11') . '","90":"' . trans('admin.backup_frequency_option_12') . '","180":"' . trans('admin.backup_frequency_option_13') . '","360":"' . trans('admin.backup_frequency_option_14') . '"},
	...
	{"name":"backup_cleanup_keep_days","label":"backup_cleanup_keep_days_label","type":"number","hint":"backup_cleanup_keep_days_hint","wrapperAttributes":{"class":"form-group col-md-6"}},
	{"name":"backup_cleanup_dobwummt","label":"backup_cleanup_dobwummt_label","type":"number","hint":"backup_cleanup_dobwummt_hint","wrapperAttributes":{"class":"form-group col-md-6"}},
	...
	{"name":"backup_link_btn_hint","type":"custom_html","value":"backup_link_btn_hint_value"}';
		...
		if (config('plugins.watermark.installed')) {
			if ($this->key == 'watermark') {
				$value = \extras\plugins\watermark\Watermark::getFieldData();
			}
		}
		
		if (config('plugins.reviews.installed')) {
			if ($this->key == 'reviews') {
				$value = \extras\plugins\reviews\Reviews::getFieldData();
			}
		}
		
		if (config('plugins.currencyexchange.installed')) {
			if ($this->key == 'currency_exchange') {
				$value = \extras\plugins\currencyexchange\Currencyexchange::getFieldData();
			}
		}
		
		if (config('plugins.domainmapping.installed')) {
			if ($this->key == 'domain_mapping') {
				$value = \extras\plugins\domainmapping\Domainmapping::getFieldData();
			}
		}
