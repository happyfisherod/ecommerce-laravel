...
--
-- Host: localhost:3306
-- Generation Time: Jun 10, 2016 at 04:30 PM
...
INSERT INTO `<<prefix>>categories` (`id`, `translation_lang`, `translation_of`, `parent_id`, `name`, `slug`, `description`, `picture`, `icon_class`, `lft`, `rgt`, `depth`, `type`, `is_for_permanent`, `active`) VALUES
(1, 'en', 1, 0, 'Automobiles', 'automobiles', NULL, 'app/categories/skin-default/fa-car.png', 'fa fa-car', 2, 17, 0, 'classified', 0, 1),
(2, 'en', 2, 1, 'Auto Parts, Accessories', 'auto-parts-accessories', NULL, NULL, NULL, 3, 4, 1, 'classified', 0, 1),
(3, 'en', 3, 1, 'Car, Motorcycle Rental', 'car-motorcycle-rental', NULL, NULL, NULL, 5, 6, 1, 'classified', 0, 1),
(4, 'en', 4, 1, 'Caravan and Boating', 'caravan-and-boating', NULL, NULL, NULL, 7, 8, 1, 'classified', 0, 1),
(5, 'en', 5, 1, 'Motorcycle parts, Accessories', 'motorcycle-parts-accessories', NULL, NULL, NULL, 9, 10, 1, 'classified', 0, 1),
(6, 'en', 6, 1, 'Motorcycles, Scooters, Quads', 'motorcycles-scooters-quads', NULL, NULL, NULL, 11, 12, 1, 'classified', 0, 1),
(7, 'en', 7, 1, 'Used Cars - New Cars', 'used-cars-new-cars', NULL, NULL, NULL, 13, 14, 1, 'classified', 0, 1),
(8, 'en', 8, 1, 'Utility Vehicles, Machinery', 'utility-vehicles-machinery', NULL, NULL, NULL, 15, 16, 1, 'classified', 0, 1),
(9, 'en', 9, 0, 'Real estate', 'real-estate', NULL, 'app/categories/skin-default/fa-home.png', 'icon-home', 18, 41, 0, 'classified', 0, 1),
(10, 'en', 10, 9, 'Commercial Property - Offices - Premises', 'commercial-property-offices-premises', NULL, NULL, NULL, 19, 20, 1, 'classified', 0, 1),
(11, 'en', 11, 9, 'I''m looking for', 'im-looking-for', NULL, NULL, NULL, 21, 22, 1, 'classified', 0, 1),
(12, 'en', 12, 9, 'Roomates', 'roomates', NULL, NULL, NULL, 23, 24, 1, 'classified', 0, 1),
(13, 'en', 13, 9, 'Accommodation and Hotels', 'accommodation-and-hotels', NULL, NULL, NULL, 25, 26, 1, 'classified', 0, 1),
(14, 'en', 14, 9, 'Vacation Rental', 'vacation-rental', NULL, NULL, NULL, 27, 28, 1, 'classified', 0, 1),
(15, 'en', 15, 9, 'Garage, Parking, Farms', 'garage-parking-farms', NULL, NULL, NULL, 29, 30, 1, 'classified', 0, 1),
(16, 'en', 16, 9, 'Real Estate Services', 'real-estate-services', NULL, NULL, NULL, 31, 32, 1, 'classified', 0, 1),
(17, 'en', 17, 9, 'Rooms - Studio for Rent', 'rooms-studio-for-rent', NULL, NULL, NULL, 33, 34, 1, 'classified', 0, 1),
(18, 'en', 18, 9, 'Land for Sale, Rent', 'land-for-sale-rent', NULL, NULL, NULL, 35, 36, 1, 'classified', 0, 1),
(19, 'en', 19, 9, 'Property for sale', 'property-for-sale', NULL, NULL, NULL, 37, 38, 1, 'classified', 0, 1),
(20, 'en', 20, 9, 'Rentals', 'rentals', NULL, NULL, NULL, 39, 40, 1, 'classified', 0, 1),
(21, 'en', 21, 0, 'Services', 'services', NULL, 'app/categories/skin-default/ion-clipboard.png', 'fa fa-briefcase', 42, 77, 0, 'classified', 0, 1),
(22, 'en', 22, 21, 'Other services', 'other-services', NULL, NULL, NULL, 43, 44, 1, 'classified', 0, 1),
(23, 'en', 23, 21, 'Casting, Model, Photographer', 'casting-model-photographer', NULL, NULL, NULL, 45, 46, 1, 'classified', 0, 1),
(24, 'en', 24, 21, 'Carpooling', 'carpooling', NULL, NULL, NULL, 47, 48, 1, 'classified', 0, 1),
(25, 'en', 25, 21, 'Moving, Furniture Guard', 'moving-furniture-guard', NULL, NULL, NULL, 49, 50, 1, 'classified', 0, 1),
(26, 'en', 26, 21, 'Destocking - Commercial', 'destocking-commercial', NULL, NULL, NULL, 51, 52, 1, 'classified', 0, 1),
(27, 'en', 27, 21, 'Industrial Equipment', 'industrial-equipment', NULL, NULL, NULL, 53, 54, 1, 'classified', 0, 1),
(28, 'en', 28, 21, 'Aesthetics, Hairstyling', 'aesthetics-hairstyling', NULL, NULL, NULL, 55, 56, 1, 'classified', 0, 1),
(29, 'en', 29, 21, 'Horoscope - Tarot - Healers - Spell', 'horoscope-tarot-healers-spell', NULL, NULL, NULL, 57, 58, 1, 'classified', 0, 1),
(30, 'en', 30, 21, 'Materials and Equipment Pro', 'materials-and-equipment-pro', NULL, NULL, NULL, 59, 60, 1, 'classified', 0, 1),
(31, 'en', 31, 21, 'Event Organization Services', 'event-organization-services', NULL, NULL, NULL, 61, 62, 1, 'classified', 0, 1),
(32, 'en', 32, 21, 'Service Provision', 'service-provision', NULL, NULL, NULL, 63, 64, 1, 'classified', 0, 1),
(33, 'en', 33, 21, 'Health, Beauty', 'health-beauty', NULL, NULL, NULL, 65, 66, 1, 'classified', 0, 1),
(34, 'en', 34, 21, 'Artisan, Troubleshooting, Handyman', 'artisan-troubleshooting-handyman', NULL, NULL, NULL, 67, 68, 1, 'classified', 0, 1),
(35, 'en', 35, 21, 'Computing Services', 'computing-services', NULL, NULL, NULL, 69, 70, 1, 'classified', 0, 1),
(36, 'en', 36, 21, 'Tourism and Travel Services', 'tourism-and-travel-services', NULL, NULL, NULL, 71, 72, 1, 'classified', 0, 1),
(37, 'en', 37, 21, 'Translation, Writing', 'translation-writing', NULL, NULL, NULL, 73, 74, 1, 'classified', 0, 1),
(38, 'en', 38, 21, 'Construction - Renovation - Carpentry', 'construction-renovation-carpentry', NULL, NULL, NULL, 75, 76, 1, 'classified', 0, 1),
(39, 'en', 39, 0, 'Community', 'community', NULL, 'app/categories/skin-default/fa-users.png', 'icon-theatre', 78, 93, 0, 'classified', 0, 1),
(40, 'en', 40, 39, 'Sporting goods, Exercise', 'sporting-goods-exercise', NULL, NULL, NULL, 79, 80, 1, 'classified', 0, 1),
(41, 'en', 41, 39, 'Artists, Musicians', 'artists-musicians', NULL, NULL, NULL, 81, 82, 1, 'classified', 0, 1),
(42, 'en', 42, 39, 'Associations, Voluntary', 'associations-voluntary', NULL, NULL, NULL, 83, 84, 1, 'classified', 0, 1),
(43, 'en', 43, 39, 'Friendships for Events', 'friendships-for-events', NULL, NULL, NULL, 85, 86, 1, 'classified', 0, 1),
(44, 'en', 44, 39, 'My neighborhood', 'my-neighborhood', NULL, NULL, NULL, 87, 88, 1, 'classified', 0, 1),
(45, 'en', 45, 39, 'Nightlife, Restaurant & Bar', 'nightlife-restaurant-bar', NULL, NULL, NULL, 89, 90, 1, 'classified', 0, 1),
(46, 'en', 46, 39, 'Outings, Entertainment', 'outings-entertainment', NULL, NULL, NULL, 91, 92, 1, 'classified', 0, 1),
(47, 'en', 47, 0, 'Multimedia', 'multimedia', NULL, 'app/categories/skin-default/fa-laptop.png', 'icon-laptop', 94, 117, 0, 'classified', 0, 1),
(48, 'en', 48, 47, 'Multimedia & Phones Accessories', 'multimedia-phones-accessories', NULL, NULL, NULL, 95, 96, 1, 'classified', 0, 1),
(49, 'en', 49, 47, 'CD/DVD - Books - Movies', 'cddvd-books-movies', NULL, NULL, NULL, 97, 98, 1, 'classified', 0, 1),
(50, 'en', 50, 47, 'Consoles - Video Games', 'consoles-video-games', NULL, NULL, NULL, 99, 100, 1, 'classified', 0, 1),
(51, 'en', 51, 47, 'Computers - PC - Office Supplies', 'computers-pc-office-supplies', NULL, NULL, NULL, 101, 102, 1, 'classified', 0, 1),
(52, 'en', 52, 47, 'Wanted', 'wanted', NULL, NULL, NULL, 103, 104, 1, 'classified', 0, 1),
(53, 'en', 53, 47, 'Tablets - Touchscreens', 'tablets-touchscreens', NULL, NULL, NULL, 105, 106, 1, 'classified', 0, 1),
(54, 'en', 54, 47, 'Mobiles phones - Smartphones', 'mobiles-phones-smartphones', NULL, NULL, NULL, 107, 108, 1, 'classified', 0, 1),
(55, 'en', 55, 47, 'TV - Images - Sound', 'tv-images-sound', NULL, NULL, NULL, 109, 110, 1, 'classified', 0, 1),
(56, 'en', 56, 47, 'Clearance - Commercial', 'clearance-commercial', NULL, NULL, NULL, 111, 112, 1, 'classified', 0, 1),
(57, 'en', 57, 47, 'Industrial Equipment', 'industrial-equipment', NULL, NULL, NULL, 113, 114, 1, 'classified', 0, 1),
(58, 'en', 58, 47, 'Materials & Professional equipment', 'materials-professional-equipment', NULL, NULL, NULL, 115, 116, 1, 'classified', 0, 1),
(59, 'en', 59, 0, 'Fashion, Home & Garden', 'fashion-home-garden', NULL, 'app/categories/skin-default/fa-home.png', 'icon-basket-1', 118, 143, 0, 'classified', 0, 1),
(60, 'en', 60, 59, 'Furniture - Tableware', 'furniture-tableware', NULL, NULL, NULL, 119, 120, 1, 'classified', 0, 1),
(61, 'en', 61, 59, 'Antiques - Art - Decoration', 'antiques-art-decoration', NULL, NULL, NULL, 121, 122, 1, 'classified', 0, 1),
(62, 'en', 62, 59, 'Appliances', 'appliances', NULL, NULL, NULL, 123, 124, 1, 'classified', 0, 1),
(63, 'en', 63, 59, 'Jewelry - Watches - Luggage', 'jewelry-watches-luggage', NULL, NULL, NULL, 125, 126, 1, 'classified', 0, 1),
(64, 'en', 64, 59, 'DIY - Gardening', 'diy-gardening', NULL, NULL, NULL, 127, 128, 1, 'classified', 0, 1),
(65, 'en', 65, 59, 'Various flea markets', 'various-flea-markets', NULL, NULL, NULL, 129, 130, 1, 'classified', 0, 1),
(66, 'en', 66, 59, 'Shoes', 'shoes', NULL, NULL, NULL, 131, 132, 1, 'classified', 0, 1),
(67, 'en', 67, 59, 'Toys - Games - Figurines', 'toys-games-figurines', NULL, NULL, NULL, 133, 134, 1, 'classified', 0, 1),
(68, 'en', 68, 59, 'Clothing, Fashion & Accessories', 'clothing-fashion-accessories', NULL, NULL, NULL, 135, 136, 1, 'classified', 0, 1),
(69, 'en', 69, 59, 'Stuffs for Baby and Child', 'stuffs-for-baby-and-child', NULL, NULL, NULL, 137, 138, 1, 'classified', 0, 1),
(70, 'en', 70, 59, 'Stuffs for Beauty and Health', 'stuffs-for-beauty-and-health', NULL, NULL, NULL, 139, 140, 1, 'classified', 0, 1),
(71, 'en', 71, 59, 'Wine & Gourmet - Recipes', 'wine-gourmet-recipes', NULL, NULL, NULL, 141, 142, 1, 'classified', 0, 1),
(72, 'en', 72, 0, 'Pets & Mascots', 'pets-mascots', NULL, 'app/categories/skin-default/map-icon-pet-store.png', 'icon-guidedog', 144, 149, 0, 'classified', 0, 1),
(73, 'en', 73, 72, 'Accessories - Other Pets services', 'accessories-other-pets-services', NULL, NULL, NULL, 145, 146, 1, 'classified', 0, 1),
(74, 'en', 74, 72, 'Sales, Adoptions, Lost', 'sales-adoptions-lost', NULL, NULL, NULL, 147, 148, 1, 'classified', 0, 1),
(75, 'en', 75, 0, 'Free Dating', 'free-dating', NULL, 'app/categories/skin-default/ion-ios-heart.png', 'icon-heart', 150, 169, 0, 'not-salable', 0, 1),
(76, 'en', 76, 75, 'Friendship - Friends', 'friendship-friends', NULL, NULL, NULL, 151, 152, 1, 'not-salable', 0, 1),
(77, 'en', 77, 75, 'Escorts - Adult Services', 'escorts-adult-services', NULL, NULL, NULL, 153, 154, 1, 'not-salable', 0, 1),
(78, 'en', 78, 75, 'Women Seeking Women', 'women-seeking-women', NULL, NULL, NULL, 155, 156, 1, 'not-salable', 0, 1),
(79, 'en', 79, 75, 'Women Seeking Men', 'women-seeking-men', NULL, NULL, NULL, 157, 158, 1, 'not-salable', 0, 1),
(80, 'en', 80, 75, 'Men Seeking Women', 'men-seeking-women', NULL, NULL, NULL, 159, 160, 1, 'not-salable', 0, 1),
(81, 'en', 81, 75, 'Men Seeking Men', 'men-seeking-men', NULL, NULL, NULL, 161, 162, 1, 'not-salable', 0, 1),
(82, 'en', 82, 75, 'Massage Services - Relaxation', 'massage-services-relaxation', NULL, NULL, NULL, 163, 164, 1, 'not-salable', 0, 1),
(83, 'en', 83, 75, 'Adults Products - Articles', 'adults-products-articles', NULL, NULL, NULL, 165, 166, 1, 'not-salable', 0, 1),
(84, 'en', 84, 75, 'Casual Encounter', 'casual-encounter', NULL, NULL, NULL, 167, 168, 1, 'not-salable', 0, 1),
(85, 'en', 85, 0, 'Jobs Offers', 'jobs-offers', NULL, 'app/categories/skin-default/mfglabs-users.png', 'icon-megaphone-1', 170, 217, 0, 'job-offer', 0, 1),
(86, 'en', 86, 85, 'Agriculture - Environment', 'agriculture-environment', NULL, NULL, NULL, 171, 172, 1, 'classified', 0, 1),
(87, 'en', 87, 85, 'Assistantship - Secretariat - Helpdesk', 'assistantship-secretariat-helpdesk', NULL, NULL, NULL, 173, 174, 1, 'classified', 0, 1),
(88, 'en', 88, 85, 'Automotive - Mechanic', 'automotive-mechanic', NULL, NULL, NULL, 175, 176, 1, 'classified', 0, 1),
(89, 'en', 89, 85, 'Others Jobs Offer', 'others-jobs-offer', NULL, NULL, NULL, 177, 178, 1, 'classified', 0, 1),
(90, 'en', 90, 85, 'BTP - Construction - Building', 'btp-construction-building', NULL, NULL, NULL, 179, 180, 1, 'classified', 0, 1),
(91, 'en', 91, 85, 'Trade - Business Services', 'trade-business-services', NULL, NULL, NULL, 181, 182, 1, 'classified', 0, 1),
(92, 'en', 92, 85, 'Commercial - Sale Jobs Offer', 'commercial-sale-jobs-offer', NULL, NULL, NULL, 183, 184, 1, 'classified', 0, 1),
(93, 'en', 93, 85, 'Accounting - Management - Finance', 'accounting-management-finance', NULL, NULL, NULL, 185, 186, 1, 'classified', 0, 1),
(94, 'en', 94, 85, 'Steering - Manager', 'steering-manager', NULL, NULL, NULL, 187, 188, 1, 'classified', 0, 1),
(95, 'en', 95, 85, 'Aesthetics - Hair - Beauty', 'aesthetics-hair-beauty', NULL, NULL, NULL, 189, 190, 1, 'classified', 0, 1),
(96, 'en', 96, 85, 'Public Service Jobs Offer', 'public-service-jobs-offer', NULL, NULL, NULL, 191, 192, 1, 'classified', 0, 1),
(97, 'en', 97, 85, 'Real Estate Jobs Offer', 'real-estate-jobs-offer', NULL, NULL, NULL, 193, 194, 1, 'classified', 0, 1),
(98, 'en', 98, 85, 'Independent - Freelance - Telecommuting', 'independent-freelance-telecommuting', NULL, NULL, NULL, 195, 196, 1, 'classified', 0, 1),
(99, 'en', 99, 85, 'Computers - Internet - Telecommunications', 'computers-internet-telecommunications', NULL, NULL, NULL, 197, 198, 1, 'classified', 0, 1),
(100, 'en', 100, 85, 'Industry, Production & engineering', 'industry-production-engineering', NULL, NULL, NULL, 199, 200, 1, 'classified', 0, 1),
(101, 'en', 101, 85, 'Marketing - Communication', 'marketing-communication', NULL, NULL, NULL, 201, 202, 1, 'classified', 0, 1),
(102, 'en', 102, 85, 'Babysitting - Nanny Work', 'babysitting-nanny-work', NULL, NULL, NULL, 203, 204, 1, 'classified', 0, 1),
(103, 'en', 103, 85, 'HR - Training - Education', 'hr-training-education', NULL, NULL, NULL, 205, 206, 1, 'classified', 0, 1),
(104, 'en', 104, 85, 'Medical - Healthcare - Social', 'medical-healthcare-social', NULL, NULL, NULL, 207, 208, 1, 'classified', 0, 1),
(105, 'en', 105, 85, 'Security - Guarding', 'security-guarding', NULL, NULL, NULL, 209, 210, 1, 'classified', 0, 1),
(106, 'en', 106, 85, 'Household Services - Housekeeping', 'household-services-housekeeping', NULL, NULL, NULL, 211, 212, 1, 'classified', 0, 1),
(107, 'en', 107, 85, 'Tourism - Hotels - Restaurants - Leisure', 'tourism-hotels-restaurants-leisure', NULL, NULL, NULL, 213, 214, 1, 'classified', 0, 1),
(108, 'en', 108, 85, 'Transportation - Logistics', 'transportation-logistics', NULL, NULL, NULL, 215, 216, 1, 'classified', 0, 1),
(109, 'en', 109, 0, 'Job Search', 'job-search', NULL, 'app/categories/skin-default/fa-search.png', 'icon-search', 218, 265, 0, 'job-search', 0, 1),
(110, 'en', 110, 109, 'Agriculture - Environment', 'agriculture-environment', NULL, NULL, NULL, 219, 220, 1, 'job-search', 0, 1),
(111, 'en', 111, 109, 'Assistantship - Secretariat - Helpdesk', 'assistantship-secretariat-helpdesk', NULL, NULL, NULL, 221, 222, 1, 'job-search', 0, 1),
(112, 'en', 112, 109, 'Automotive - Mechanic', 'automotive-mechanic', NULL, NULL, NULL, 223, 224, 1, 'job-search', 0, 1),
(113, 'en', 113, 109, 'Others Jobs Search', 'others-jobs-search', NULL, NULL, NULL, 225, 226, 1, 'job-search', 0, 1),
(114, 'en', 114, 109, 'BTP - Construction - Building', 'btp-construction-building', NULL, NULL, NULL, 227, 228, 1, 'job-search', 0, 1),
(115, 'en', 115, 109, 'Trade - Business Services', 'trade-business-services', NULL, NULL, NULL, 229, 230, 1, 'job-search', 0, 1),
(116, 'en', 116, 109, 'Commercial - Sale Jobs Search', 'commercial-sale-jobs-search', NULL, NULL, NULL, 231, 232, 1, 'job-search', 0, 1),
(117, 'en', 117, 109, 'Accounting - Management - Finance', 'accounting-management-finance', NULL, NULL, NULL, 233, 234, 1, 'job-search', 0, 1),
(118, 'en', 118, 109, 'Steering - Manager', 'steering-manager', NULL, NULL, NULL, 235, 236, 1, 'job-search', 0, 1),
(119, 'en', 119, 109, 'Aesthetics - Hair - Beauty', 'aesthetics-hair-beauty', NULL, NULL, NULL, 237, 238, 1, 'job-search', 0, 1),
(120, 'en', 120, 109, 'Public Service Jobs Search', 'public-service-jobs-search', NULL, NULL, NULL, 239, 240, 1, 'job-search', 0, 1),
(121, 'en', 121, 109, 'Real Estate Jobs Search', 'real-estate-jobs-search', NULL, NULL, NULL, 241, 242, 1, 'job-search', 0, 1),
(122, 'en', 122, 109, 'Independent - Freelance - Telecommuting', 'independent-freelance-telecommuting', NULL, NULL, NULL, 243, 244, 1, 'job-search', 0, 1),
(123, 'en', 123, 109, 'Computers - Internet - Telecommunications', 'computers-internet-telecommunications', NULL, NULL, NULL, 245, 246, 1, 'job-search', 0, 1),
(124, 'en', 124, 109, 'Industry, Production & engineering', 'industry-production-engineering', NULL, NULL, NULL, 247, 248, 1, 'job-search', 0, 1),
(125, 'en', 125, 109, 'Marketing - Communication', 'marketing-communication', NULL, NULL, NULL, 249, 250, 1, 'job-search', 0, 1),
(126, 'en', 126, 109, 'Babysitting - Nanny Work', 'babysitting-nanny-work', NULL, NULL, NULL, 251, 252, 1, 'job-search', 0, 1),
(127, 'en', 127, 109, 'HR - Training - Education', 'hr-training-education', NULL, NULL, NULL, 253, 254, 1, 'job-search', 0, 1),
(128, 'en', 128, 109, 'Medical - Healthcare - Social', 'medical-healthcare-social', NULL, NULL, NULL, 255, 256, 1, 'job-search', 0, 1),
(129, 'en', 129, 109, 'Security - Guarding', 'security-guarding', NULL, NULL, NULL, 257, 258, 1, 'job-search', 0, 1),
(130, 'en', 130, 109, 'Household Services - Housekeeping', 'household-services-housekeeping', NULL, NULL, NULL, 259, 260, 1, 'job-search', 0, 1),
(131, 'en', 131, 109, 'Tourism - Hotels - Restaurants - Leisure', 'tourism-hotels-restaurants-leisure', NULL, NULL, NULL, 261, 262, 1, 'job-search', 0, 1),
(132, 'en', 132, 109, 'Transportation - Logistics', 'transportation-logistics', NULL, NULL, NULL, 263, 264, 1, 'job-search', 0, 1),
(133, 'en', 133, 0, 'Learning', 'learning', NULL, 'app/categories/skin-default/fa-graduation-cap.png', 'icon-book-open', 266, 281, 0, 'classified', 0, 1),
(134, 'en', 134, 133, 'Language Classes', 'language-classes', NULL, NULL, NULL, 267, 268, 1, 'classified', 0, 1),
(135, 'en', 135, 133, 'Computer Courses', 'computer-courses', NULL, NULL, NULL, 269, 270, 1, 'classified', 0, 1),
(136, 'en', 136, 133, 'Tutoring, Private Lessons', 'tutoring-private-lessons', NULL, NULL, NULL, 271, 272, 1, 'classified', 0, 1),
(137, 'en', 137, 133, 'Vocational Training', 'vocational-training', NULL, NULL, NULL, 273, 274, 1, 'classified', 0, 1),
(138, 'en', 138, 133, 'Maths, Physics, Chemistry', 'maths-physics-chemistry', NULL, NULL, NULL, 275, 276, 1, 'classified', 0, 1),
(139, 'en', 139, 133, 'Music, Theatre, Dance', 'music-theatre-dance', NULL, NULL, NULL, 277, 278, 1, 'classified', 0, 1),
(140, 'en', 140, 133, 'School support', 'school-support', NULL, NULL, NULL, 279, 280, 1, 'classified', 0, 1),
(141, 'en', 141, 0, 'Local Events', 'local-events', NULL, 'app/categories/skin-default/fa-calendar.png', 'icon-megaphone-1', 282, 307, 0, 'classified', 0, 1),
(142, 'en', 142, 141, 'Concerts & Festivals', 'concerts-festivals', NULL, NULL, NULL, 283, 284, 1, 'classified', 0, 1),
(143, 'en', 143, 141, 'Networking & Meetups', 'networking-meetups', NULL, NULL, NULL, 285, 286, 1, 'classified', 0, 1),
(144, 'en', 144, 141, 'Sports & Outdoors', 'sports-outdoors', NULL, NULL, NULL, 287, 288, 1, 'classified', 0, 1),
(145, 'en', 145, 141, 'Trade Shows & Conventions', 'trade-shows-conventions', NULL, NULL, NULL, 289, 290, 1, 'classified', 0, 1),
(146, 'en', 146, 141, 'Training & Seminars', 'training-seminars', NULL, NULL, NULL, 291, 292, 1, 'classified', 0, 1),
(147, 'en', 147, 141, 'Ceremonies', 'ceremonies', NULL, NULL, NULL, 293, 294, 1, 'classified', 0, 1),
(148, 'en', 148, 141, 'Conferences', 'conferences', NULL, NULL, NULL, 295, 296, 1, 'classified', 0, 1),
(149, 'en', 149, 141, 'Weddings', 'weddings', NULL, NULL, NULL, 297, 298, 1, 'classified', 0, 1),
(150, 'en', 150, 141, 'Birthdays', 'birthdays', NULL, NULL, NULL, 299, 300, 1, 'classified', 0, 1),
(151, 'en', 151, 141, 'Family Events', 'family-events', NULL, NULL, NULL, 301, 302, 1, 'classified', 0, 1),
(152, 'en', 152, 141, 'Nightlife', 'nightlife', NULL, NULL, NULL, 303, 304, 1, 'classified', 0, 1),
(153, 'en', 153, 141, 'All others events', 'all-others-events', NULL, NULL, NULL, 305, 306, 1, 'classified', 0, 1);
...
INSERT INTO `<<prefix>>fields` (`id`, `belongs_to`, `translation_lang`, `translation_of`, `name`, `type`, `max`, `default`, `required`, `use_as_filter`, `help`, `active`) VALUES
...
INSERT INTO `<<prefix>>packages` (`id`, `translation_lang`, `translation_of`, `name`, `short_name`, `ribbon`, `has_badge`, `price`, `currency_code`, `promo_duration`, `duration`, `pictures_limit`, `description`, `facebook_ads`, `google_ads`, `twitter_ads`, `recommended`, `parent_id`, `lft`, `rgt`, `depth`, `active`) VALUES
(1, 'en', 1, 'Regular List', 'Free', 'red', 1, '0.00', 'USD', NULL, NULL, NULL, NULL, 0, 0, 0, 0, 0, 2, 3, 0, 1),
(2, 'en', 2, 'Top page Ad', 'Premium', 'orange', 1, '7.50', 'USD', 7, 60, 10, 'Featured on the Homepage\r\nFeatured in the Category', 0, 0, 0, 1, 0, 4, 5, 0, 1),
(3, 'en', 3, 'Top page Ad+', 'Premium+', 'green', 1, '9.00', 'USD', 30, 120, 15, 'Featured on the Homepage\r\nFeatured in the Category', 0, 0, 0, 0, 0, 6, 7, 0, 1);
...
INSERT INTO `<<prefix>>settings` (`id`, `key`, `name`, `value`, `description`, `field`, `parent_id`, `lft`, `rgt`, `depth`, `active`, `created_at`, `updated_at`) VALUES(4, 'single', 'Ads (Form & Single Page)', NULL, 'Ads (Form & Single Page) Options', NULL, 0, 8, 9, 1, 1, NULL, NULL);
